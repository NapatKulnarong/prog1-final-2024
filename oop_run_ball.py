...
from oop_seven_segments_proc import Turtle

Tom = turtle.Turtle()
tom_color = (255, 0, 0)
tom_turtle = Turtle(Tom, tom_color)
delay_in_seconds = 0.2
while True:
    for i in range(0, 10):
        tom_turtle.clear(Tom)
        tom_turtle.draw(Tom, i)
        tom_turtle.my_delay(delay_in_seconds)
        turtle.update()
